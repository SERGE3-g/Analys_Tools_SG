...
class ChurnAnalyzer:
    ...
    def train_model(self, X_train, y_train):
        ...
        # Parameter grids ridotti al minimo per velocizzare
        rf_param_grid = {
            'n_estimators': [100],
            'max_depth': [10],
            'min_samples_split': [2],
        ...
        # Calculate feature importance with meno ripetizioni
        self.feature_importance = self.calculate_feature_importance(X_train, y_train)
        logging.info("Model training completed")

    def calculate_feature_importance(self, X, y):
        # Calculate permutation importance with meno ripetizioni
        perm_importance = permutation_importance(
            self.model.best_estimator_,
            X, y,
            n_repeats=5,  # ridotto da 10 a 5
    ...
    def evaluate_model(self, X_test, y_test):
        ...
        self.plot_model_evaluation(results)

        return results

    def plot_model_evaluation(self, results):
        # Crea la figura per i plot senza specificare lo stile
...
if __name__ == "__main__":
        ...
        # Generate sample data
        data = analyzer.generate_mock_data(1000)
