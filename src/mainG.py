...
from churn_analysis_tab import ChurnAnalysisTab  # New import for churn analysis
...
class MainApp:
    ...
    def __init__(self):
        ...
        try:
            ...
            self.churn_tab = None  # New variable for churn analysis tab
    ...
    def create_tabs(self):
        ...
        try:
            ...
            # Tab Analisi Churn (nuovo)
            self.churn_tab = ChurnAnalysisTab(self.notebook, self.current_user, self.user_role)
            self.notebook.add(self.churn_tab, text="Analisi Machine Learning")
    ...
    def perform_search(self):
        ...
        try:
            ...
            if self.churn_tab:  # Aggiunto ricerca nel tab churn
                found = self.churn_tab.search(search_term)
                if found:
                    results.extend(found)
