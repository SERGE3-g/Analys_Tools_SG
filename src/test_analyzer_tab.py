...
# Creazione dinamica della directory per il file di log
log_dir = Path(__file__).resolve().parent.parent / 'static'
log_dir.mkdir(parents=True, exist_ok=True)  # Crea la directory se non esiste

# Percorso assoluto per il file di log
log_file = log_dir / 'test_analyzer.log'
